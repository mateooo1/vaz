    ...
    <div className="flex h-full flex-col">
      <header className="flex flex-none items-center justify-between border-b border-gray-200 px-6 py-4">
        ...
        <div className="flex items-center">
          ...
          <Field>
  <Listbox name="view" defaultValue="week">
    <ListboxLabel>
    </ListboxLabel>
    
    <ListboxOption value="day">
      <ListboxLabel>Day view</ListboxLabel>
    </ListboxOption>
    <ListboxOption value="week">
      <ListboxLabel>Week view</ListboxLabel>
    </ListboxOption>
    <ListboxOption value="month">
      <ListboxLabel>Month view</ListboxLabel>
    </ListboxOption>
    <ListboxOption value="year">
      <ListboxLabel>Year view</ListboxLabel>
    </ListboxOption>
  </Listbox>
</Field>
          ...
          <Menu as="div" className="relative ml-6 md:hidden">
            ...
            >
              ...
              <div className="py-1">
              <Field>
  <Listbox name="view" defaultValue="day">
    <ListboxOption value="day">
      <ListboxLabel>Day view</ListboxLabel>
    </ListboxOption>
    <ListboxOption value="week">
