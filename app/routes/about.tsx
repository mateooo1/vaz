    ...
    <div className="bg-white">
        ...
        <div className="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-indigo-100/20 pt-14">
          ...
          <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              <h1 className="max-w-2xl text-4xl font-serif tracking-tight text-gray-900 sm:text-6xl lg:col-span-2 xl:col-auto">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                <h2 className="text-3xl font-serif tracking-tight text-gray-900 sm:text-4xl">Our people</h2>
      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <nav aria-label="Footer" className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12">
          {customfooterNavigation.main.map((item) => (
        ...
        <div className="mt-10 flex justify-center space-x-10">
          {customfooterNavigation.social.map((item) => (
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; 2024 Switzer, Inc. All rights reserved.
        </p>
      </div>
    </footer>
    </div>
